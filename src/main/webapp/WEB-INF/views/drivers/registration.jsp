...
<div class="formStyle">
    <form method="post" id="driver" action="${pageContext.request.contextPath}/register">
        ...
        <div class="formTitle">Repeat Password</div>
        <div class="formTitle">
            <input type="password" name="repeat_password" form="driver" required></br>
        </div>
        <div class="formTitle">
            <h5 class="errorMassage">${errorMessage}</h5>
        </div>
        <div class="formTitle">
            <input type="submit" name="add" form="driver" value="register" class="submit">
